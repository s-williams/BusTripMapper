...
class UtilityTest {
    ...
    @Test
    public void calculateChargeCommutativity() {
    ...
    @Test
    public void calculateChargeExpectedCompletedTrips() {
    ...
    @Test
    public void calculateChargeExpectedIncompleteTrips() {
    ...
    @Test
    public void calculateChargeExpectedError() {
